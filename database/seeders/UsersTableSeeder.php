...
class UsersTableSeeder extends Seeder
{
    ...
    protected function createNewUsers()
    {
        ...
        $d = [
            ...
            ['name' => 'Directeur École Excellence',
                'email' => 'directeur@ecole-excellence.fr',
                'username' => 'directeur',
                'password' => $password,
            ...
            ['name' => 'Professeur Martin',
                'email' => 'professeur@ecole-excellence.fr',
                'user_type' => 'teacher',
                'username' => 'professeur',
                'password' => $password,
                'code' => strtoupper(Str::random(10)),
            ...
            ['name' => 'Parent Dubois',
                'email' => 'parent@ecole-excellence.fr',
                'user_type' => 'parent',
                'username' => 'parent',
                'password' => $password,
                'code' => strtoupper(Str::random(10)),
            ...
            ['name' => 'Comptable Durand',
                'email' => 'comptable@ecole-excellence.fr',
