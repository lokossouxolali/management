            ...
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="{{ route('students.update', Qs::hash($sr->id)) }}" data-fouc>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="state_id">Région: <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select required data-placeholder="Sélectionner d'abord la région" class="select-search form-control" name="lga_id" id="lga_id">
                                    @if($sr->user->lga_id)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="d-block">Télécharger la Photo:</label>
                                <input value="{{ old('photo') }}" accept="image/*" type="file" name="photo" class="form-input-styled" data-fouc>
                                <span class="form-text text-muted">Images acceptées: jpeg, png. Taille max du fichier 2Mo</span>
                            </div>
                        </div>
                    </div>
