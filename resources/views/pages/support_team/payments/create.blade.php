            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="method" class="col-lg-3 col-form-label font-weight-semibold">Méthodes de Paiements</label>
                            <div class="col-lg-9">
                                <select class="form-control select" name="method" id="method">
                                    <option selected value="Cash">Espèce</option>
                                    <option selected value="Online">Électronique</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Enregitrer<i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
