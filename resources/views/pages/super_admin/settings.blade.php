        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row">
                            <label for="current_session" class="col-lg-3 col-form-label font-weight-semibold">Session en cours <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Fin du trimestre</label>
                            <div class="col-lg-6">
                                <input name="term_ends" value="{{ $s['term_ends'] }}" type="text" class="form-control date-pick" placeholder="Date de fin du trimestre">
                            </div>
                            <div class="col-lg-3 mt-2">
                                <span class="font-weight-bold font-italic">J-M-A ou J/M/A </span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label font-weight-semibold">Début du prochain trimestre</label>
                            <div class="col-lg-6">
                                <input name="term_begins" value="{{ $s['term_begins'] }}" type="text" class="form-control date-pick" placeholder="Date de début du prochain trimestre">
                            </div>
                            <div class="col-lg-3 mt-2">
                                <span class="font-weight-bold font-italic">J-M-A ou J/M/A </span>
                            </div>
